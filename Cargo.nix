    ...
    crates = {
      ...
      "shikumi" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "1b8560ac8d43ef04bb0b173577a09a7db6cd0d53";
          sha256 = "0hx2jdgyd326gs81d604vwddk41vxjzmy4wppxh4326w8m3z6d77";
        };
        dependencies = [
          {
            name = "arc-swap";
      ...
      "windows-sys 0.61.2" = rec {
        ...
        resolvedDefaultFeatures = [ "Wdk" "Wdk_Foundation" "Wdk_Storage" "Wdk_Storage_FileSystem" "Wdk_System" "Wdk_System_IO" "Win32" "Win32_Foundation" "Win32_Globalization" "Win32_Networking" "Win32_Networking_WinSock" "Win32_Security" "Win32_Storage" "Win32_Storage_FileSystem" "Win32_System" "Win32_System_Com" "Win32_System_Console" "Win32_System_IO" "Win32_System_Pipes" "Win32_System_SystemInformation" "Win32_System_WindowsProgramming" "Win32_UI" "Win32_UI_Shell" "default" ];
      };
      "windows-targets" = rec {
